...
from otx.algorithms.common.utils import UncopiableDefaultDict, set_random_seed, torch_save_w_distributed_train
...
class OTXTask(IInferenceTask, IExportTask, IEvaluationTask, IUnload, ABC):
    ...
    def _load_model(self):
        ...
        if state_dict:
            ...
            torch_save_w_distributed_train(state_dict, self._model_ckpt)
